...
# Travis CI Status [![Build Status](https://travis-ci.org/venkateshamurthy/design-patterns.svg?branch=master)](https://travis-ci.org/venkateshamurthy/design-patterns)
